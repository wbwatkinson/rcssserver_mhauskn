...
ServerParam::addParams()
{
    ...
    addParam( "hfo_beyond_kickable", M_hfo_beyond_kickable, "", 9 );
    addParam( "hfo_offense_ball_dist", M_hfo_offense_ball_dist, "Distance ball is placed outside of offensive player's kickable range", 9 );
